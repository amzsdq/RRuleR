...
class RunValidationTests(unittest.TestCase):
    ...
    def test_platform_enforced_pre600_continue_accepted(self):
        r=self.record(); r.update(run_ended_at='2026-09-21T17:02:00+00:00', duration_seconds=120, close_decision='EXCEPTION', short_turn_reason='PLATFORM_ENFORCED_TERMINATION', end_reason='PLATFORM_ENFORCED_TERMINATION'); r.pop('verified_next_fast_due_at'); r.pop('normal_close_offset_seconds')
        validate(r)
    ...
    def test_custom_recurring_end_reason_accepted_at_600(self):
        r=self.record(); r['end_reason']='VERIFIED_SAME_CANONICAL_CUSTOM_RECURRING_CONTINUATION'; r.pop('verified_next_fast_due_at'); r.pop('normal_close_offset_seconds')
        validate(r)
