...
class WorkEvidenceValidatorTests(unittest.TestCase):
    ...
    def test_fixed_window_start_is_canonical_utc_instant(self):
        self.assertEqual(validator.fixed_window_start("2026-09-21T05:07:31+09:00").isoformat(),"2026-09-20T20:00:00+00:00"); self.assertEqual(validator.fixed_window_start("2026-09-20T20:07:31+00:00").isoformat(),"2026-09-20T20:00:00+00:00")
    def test_equivalent_offsets_enumerate_identical_windows(self):
        a=validator.enumerate_completed_fixed_windows("2026-09-21T05:02:00+09:00","2026-09-21T05:46:00+09:00"); b=validator.enumerate_completed_fixed_windows("2026-09-20T20:02:00+00:00","2026-09-20T20:46:00+00:00"); self.assertEqual(a,b); self.assertEqual(a,["2026-09-20T20:15:00+00:00","2026-09-20T20:30:00+00:00"])
    def test_exact_boundary_allows_that_fixed_window(self): self.assertEqual(validator.enumerate_completed_fixed_windows("2026-09-21T05:00:00+09:00","2026-09-21T05:15:00+09:00"),["2026-09-20T20:00:00+00:00"])
    ...
    def test_three_consecutive_valid_windows_pass_with_deterministic_mean(self):
        data={"records":[rec("2026-09-21T05:00:00+09:00","2026-09-21T05:14:00+09:00",record_id="A"),rec("2026-09-21T05:15:00+09:00","2026-09-21T05:29:00+09:00",record_id="B"),rec("2026-09-21T05:30:00+09:00","2026-09-21T05:44:00+09:00",record_id="C")]}; out=validator.evaluate_consecutive_windows(data,"2026-09-21T05:00:00+09:00","2026-09-21T05:45:00+09:00"); self.assertEqual(out["selected_windows"],["2026-09-20T20:00:00+00:00","2026-09-20T20:15:00+00:00","2026-09-20T20:30:00+00:00"]); self.assertEqual(out["rolling_mean_useful_seconds"],840); self.assertEqual(out["p0_acceptance"],"PASS")
    def test_nonconsecutive_valid_windows_do_not_pass(self):
        data={"records":[rec("2026-09-21T05:00:00+09:00","2026-09-21T05:14:00+09:00",record_id="A"),rec("2026-09-21T05:30:00+09:00","2026-09-21T05:44:00+09:00",record_id="C"),rec("2026-09-21T05:45:00+09:00","2026-09-21T05:59:00+09:00",record_id="D")]}; out=validator.evaluate_consecutive_windows(data,"2026-09-21T05:00:00+09:00","2026-09-21T06:00:00+09:00"); self.assertEqual(out["longest_consecutive_accepted"],2); self.assertEqual(out["selected_windows"],[]); self.assertIsNone(out["rolling_mean_useful_seconds"]); self.assertEqual(out["p0_acceptance"],"NOT_YET")
