...
class WorkEvidenceValidatorTests(unittest.TestCase):
    ...
    def test_rejects_duplicate_record_identity(self):
        data={"records":[rec("2026-09-21T05:00:00+09:00","2026-09-21T05:07:00+09:00",record_id="DUP"),rec("2026-09-21T05:08:00+09:00","2026-09-21T05:15:00+09:00",record_id="DUP")]}
        out=validator.audit(data,"2026-09-21T05:00:00+09:00","2026-09-21T05:15:00+09:00"); self.assertEqual(out["duplicate_record_ids"],["DUP"]); self.assertEqual(out["promotion"],"REJECTED")
    ...
    def test_fixed_window_start_is_deterministic_local_quarter_boundary(self):
        self.assertEqual(validator.fixed_window_start("2026-09-21T05:07:31+09:00").isoformat(),"2026-09-21T05:00:00+09:00")
        self.assertEqual(validator.fixed_window_start("2026-09-21T05:15:00+09:00").isoformat(),"2026-09-21T05:15:00+09:00")
    def test_enumerates_only_fully_observed_fixed_windows(self):
        self.assertEqual(validator.enumerate_completed_fixed_windows("2026-09-21T05:02:00+09:00","2026-09-21T05:46:00+09:00"),["2026-09-21T05:15:00+09:00","2026-09-21T05:30:00+09:00"])
    def test_exact_boundary_allows_that_fixed_window(self):
        self.assertEqual(validator.enumerate_completed_fixed_windows("2026-09-21T05:00:00+09:00","2026-09-21T05:15:00+09:00"),["2026-09-21T05:00:00+09:00"])
