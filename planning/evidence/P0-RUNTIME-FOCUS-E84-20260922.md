...
7. CI timing for the guarded-extension validation is not used as a bounded useful-work interval because the available workflow timestamps do not establish a trustworthy adjacent work START/END pair. The substantive fact only: integrated control-plane run `35667516451` completed successfully. No useful seconds are claimed for this item.
